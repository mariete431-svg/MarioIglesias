...
export function Testimonials({ label }: { label: string }) {
  ...
  return <section id="opiniones" className="testimonials-section section-pad" onMouseEnter={() => setPaused(true)} onMouseLeave={() => setPaused(false)}><div className="section-wrap">
    ...
    <div className="testimonials-grid">
      ...
      <Reveal delay={.08}><figure className="testimonial" aria-live="polite">
